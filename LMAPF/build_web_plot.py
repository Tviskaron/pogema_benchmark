...
def draw_web(data_dict, labels):
    ...
    plt.legend(loc='lower right', bbox_to_anchor=(1.2, 1.), fontsize=20, ncol=5)
...
def main():
    path_to_results = '.'
    algos = ['RHCR', 'Follower', 'MAMBA', 'IQL', 'VDN', 'QMIX', 'QPLEX', 'ASwitcher', 'HSwitcher', 'LSwitcher', 'EPOM', 'RePlan', 'MATS-LP']
